...
public class ProductClient {
	...
	public static void main(String[] args) {
		...
		/*
		 * Product p = os.getProduct(3); System.out.println(p);
		 */
		
		/*
		 * Product[] products = new Product[6]; products[0] = new Product(0,
		 * "Hp Laptop", 135000.00, "computer"); products[1] = new Product(0, "iPhone",
		 * 98000.00, "mobile"); products[2] = new Product(0, "Logitech Mouse", 600.00,
		 * "computer"); products[3] = new Product(0, "Sony Bravia", 125000.00, "tv");
		 * products[4] = new Product(0, "One Plus", 32000.00, "mobile"); products[5] =
		 * new Product(0, "HP Printer", 19000.00, "computer");
		 * 
		 * for(Product p : products) { os.insertProduct(p); }
		 * 
